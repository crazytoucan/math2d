...
describe("vecTransformByAff", () => {
  ...
  it("[2 0 0 2 10 20](3, 4) => (16,28)", () => {
    expectVecEqualsApprox(vecTransformByAff(vecReset(3, 4), mat2x3(2, 0, 0, 2, 10, 20)), vecReset(16, 28));
  });

  it("[0 -1 1 0 10 20](3, 4) => (14,17)", () => {
    expectVecEqualsApprox(vecTransformByAff(vecReset(3, 4), mat2x3(0, -1, 1, 0, 10, 20)), vecReset(14, 17));
  });
});
